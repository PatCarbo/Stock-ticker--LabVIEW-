...
<Project Type="Project" LVVersion="11008008">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Google - Get Data (for stock ticker).vi" Type="VI" URL="../src/Google - Get Data (for stock ticker).vi"/>
		<Item Name="Google - Raw Stock Data - Parse.vi" Type="VI" URL="../src/Google - Raw Stock Data - Parse.vi"/>
		<Item Name="Google - URL - Build (for stock ticker).vi" Type="VI" URL="../src/Google - URL - Build (for stock ticker).vi"/>
		<Item Name="Main - Stock Ticker.vi" Type="VI" URL="../src/Main - Stock Ticker.vi"/>
		<Item Name="README" Type="Document" URL="../README"/>
		<Item Name="Stock Data - Download.vi" Type="VI" URL="../src/Stock Data - Download.vi"/>
		<Item Name="Stock Data Control.ctl" Type="VI" URL="../src/Stock Data Control.ctl"/>
		<Item Name="Stock Table - Animate.vi" Type="VI" URL="../src/Stock Table - Animate.vi"/>
		<Item Name="Stock Ticker Readme.txt" Type="Document" URL="../Stock Ticker Readme.txt"/>
		<Item Name="test.lvclass" Type="LVClass" URL="../test/test.lvclass"/>
		<Item Name="Yahoo - Get Data (for stock ticker).vi" Type="VI" URL="../src/Yahoo - Get Data (for stock ticker).vi"/>
		<Item Name="Yahoo - Raw Stock Data - Parse.vi" Type="VI" URL="../src/Yahoo - Raw Stock Data - Parse.vi"/>
		<Item Name="Yahoo - URL - Build (for stock ticker).vi" Type="VI" URL="../src/Yahoo - URL - Build (for stock ticker).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Table cell - Get colour.vi" Type="VI" URL="../test/Table cell - Get colour.vi"/>
			<Item Name="Table cell - Set colour.vi" Type="VI" URL="../test/Table cell - Set colour.vi"/>
		</Item>
